...
BIN="herdr"
MANIFEST_URL="https://raw.githubusercontent.com/kuwa2005/herdr/master/distribution/latest.json"
...
main() {
    ...
    echo "     \`WWWWWW'    github.com/kuwa2005/herdr"
    echo "      II  II"
    echo ""
...
need() {
    if ! command -v "$1" >/dev/null 2>&1; then
        err "requires '$1' — install it first, or download a binary manually from https://github.com/kuwa2005/herdr/releases"
    fi
}
